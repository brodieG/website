...
Transitioning to the [ray-traced version][10] was relatively[^relative-ease]
easy thanks to the surprisingly full-featured and all-around awesome
[`rayrender`][7] package by [Tyler Morgan Wall][8].  I did have to deploy my
rendering farm[^render-farm] though.
...
* Special thanks to [Tyler Morgan Wall][8] for giving us the power to bend
  light with [`rayrender`][7].
