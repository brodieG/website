...
Let's try a warm up round.  `sys.time` is a wrapper around `system.time` that
runs the expression eleven times and returns the median timing.  It is [defined
in the appendix](#sys.time).
...
Ouch.  Even without multithreading `data.table` crushes `tapply`.
