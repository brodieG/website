...
already know about cache and other memory system effects, or if you are
...
each iteration is partially dependent on the prior iteration[^loop-dep], which
may limit how far ahead out-of-order execution can get.




In That our simple model predicts timings without
accounting for any of those things suggests the tricks are being defeated.  
