...
problem.  For example, looping through the _columns_ of a 1M row x 10 column
...
a ll this vector[^tapply-return] with as many elements as there are groups and
with the groups as the names.
