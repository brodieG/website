...
weight: 1
contenttype: article
description: "On the nature of double precision numbers, their limits, and how
to work around them."
---
```{r echo=FALSE}
...
prevents the accumulator from becoming large relative to the group sums.
...
close.  Mostly this is a curiosity, but for the rare cases where speed is
required and `data.table` is not available, we now know there is an option.
