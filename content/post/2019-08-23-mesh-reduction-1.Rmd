...
Thankfully we now have `watcher` available to see what the code does.  



Jkk
and while it looks deceptively simple it is
too complex for me to visualize its execution in my head.  
