...
tri.sq <- extract_mesh2(err, 1, 2)
tri.di <- extract_mesh2(err, 1, 3)
...
# By design the trianble vertices are ordered so the first two vertices define
# the hypotenuse.  They are also drawn in order but due to the oob business it's
# not entirely obviousl what the final order is, so compute the angle between
# hypotenuse and opposite vertex.
