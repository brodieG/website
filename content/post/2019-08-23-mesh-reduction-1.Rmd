...
of each triangle.  Here we show the errors on a simplified 3x3 elevation
surface:
...
the error is shown as checkered bars emanating from the middle of the
hypotenuses of the mesh triangles.
