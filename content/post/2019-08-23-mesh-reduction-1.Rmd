...
Furthermore, the children for each midpoint can be computed by adding or
subtracting the same fixed number of rows and columns to the midpoint
coordinates for any given layer:
...
The performance comparison is even more noteworthy at larger grid sizes:
...
p1 + p2 + plot_layout(guides='collect') +
  plot_annotation(title='Computation Time vs Grid Size')
```
