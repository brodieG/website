...
par3d(windowRect=c(0,0,2 * width, height))
par3d(viewport=c(0,0,width, height))

persp_elev <- function(elevation, sh)
  persp3d(
...
persp_elev(mx, sh.s)
rgl.spheres(x=fp[1], y=fp[2], z=fp[3], color='red', r=20)
aspect3d(1.5, 1.5, .75)
view3d(-angle, 0, zoom=0.70)

next3d()
par3d(viewport=c(.55*width,0,width,height))
persp_elev(mx, sh.s)
rgl.spheres(x=fp[1], y=fp[2], z=fp[3], color='red', r=20)
aspect3d(1.5, 1.5, .75)
view3d(angle, 0, zoom=0.70)
