...
applicable to tall and skinny data; i.e. data with a very high ratio of
observations to variables.  Given that this type of data is fairly common, it
seems worth showing the methods for working with list data structures.  In my
particular use case I saw speed improvements on the order of 2x to 4x.

If you are bored easily you might want to skip straight to the [case
study](#a-case-study) section of this post.
...
point.  We show here three different points (red crosses) with the barycentric
...
If your data is tall and skinny, list data structures can improve performance
without compiled code or additional external dependencies.  Most operations are
comparable in speed whether done with matrices or lists, but some key operations
are faster and that make some tasks noticeably more efficient.
