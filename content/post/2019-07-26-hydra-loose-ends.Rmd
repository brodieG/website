...
dat40 <- rbind(fill=TRUE, group.longest, group.longest.end, dat30)
dat40[, step:=4L]

 # move group labels and longest group
...
dat80 <- rbind(fill=TRUE,
  dat60[!label %in% c('group-longest', 'group-longest-end', 'group-lab')],
...
steps <- c(
  ...
  "We Need As Many Cols as Groups...",
  "As Many  Rows as Elements in Longest Group...",
  "And The Matrix to Hold Them",
...
dat <- rbind(
  ...
  dat60, dat80, dat90, dat100, dat110,
  dat120
)
