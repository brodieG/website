...
dat20 <- rbind(
  dat10[order(g2)][, `:=`(label='main-back', x=gx, y=gy)],
...
# ## gganimate
#
p <- make_plot(dat, dat.code, text.size=24)
...
anim_save(
  ...
  width=1280, height=800, nframes=40, fps=5
)
# anim_save(
...
png(sprintf(png.root, i + i.off), width=800, height=499, bg='black')
