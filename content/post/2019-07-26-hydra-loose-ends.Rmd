...
anim_save(
  ...
  p +  transition_states(step, wrap=FALSE, state_length=3) +
    labs(title = "{closest_state}"),
  width=800, height=557, end_pause=5, nframes=50, fps=3
)

png.root <- '~/Downloads/colsums/img%s.png'
...
var fps_def = 0.5;
var img_n = 5;    // zero indexed, so, this is 6 images
</script>
