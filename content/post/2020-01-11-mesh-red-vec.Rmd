...
About a [year ago][1] I wrote about ([&commat;mourner][5]) fantastic [observable
notebook][6] on adapting the Will Evans etal.  Right-Triangulated Irregular
Networks [(RTIN) algorithm][8] 
