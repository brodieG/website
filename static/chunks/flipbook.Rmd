...
You must also specify how many images there are using the img_n global variable.
...
function draw() {
  ...
  console.log(imgs.children[0].width);
  console.log(imgs.children[0].naturalWidth);
  if(!flipbook_init) {
    flipbook.width = imgs.children[0].naturalWidth;
    flipbook.height = imgs.children[0].naturalHeight;
  }
  console.log(imgs.children[0].src);
  console.log(flipbook.width + " " + flipbook.height);
  ctx.drawImage(
...
window.addEventListener("load", function() {draw(); flipbook_init=true;});
</script>
